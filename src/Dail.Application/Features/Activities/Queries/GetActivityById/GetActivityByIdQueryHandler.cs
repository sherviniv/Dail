...
public class GetActivityByIdQueryHandler : IRequestHandler<GetActivityByIdQuery, ActivityViewModel>
{
    ...
    {
        var model = await _context.Activities.AsNoTracking()
        ...
        var vm = _mapper.Map<ActivityViewModel>(model);
        return vm;
    }
}